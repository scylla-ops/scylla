...
} from '@/modules/features/roles/presentation/hooks/use-grant-target-labels.ts';
import GrantCreator from '@/modules/features/roles/presentation/ui/components/role-detail/GrantCreator.tsx';
