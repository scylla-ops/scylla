...
} from '@/modules/features/role/domain/entities/effective-permissions.entity.ts';
import { useMyPermissions } from '@/modules/features/role/presentation/hooks/use-my-permissions.ts';
