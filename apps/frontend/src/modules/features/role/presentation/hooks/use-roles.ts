...
import type { CreateRoleInput } from '@/modules/features/role/domain/usecases/create-role.use-case.ts';
import type { UpdateRoleInput } from '@/modules/features/role/domain/usecases/update-role.use-case.ts';
