...
import type { CreateGrantInput } from '@/modules/features/role/domain/repository/permission.repository.ts';
import { ScyllaResult } from '@shared/utils/scylla-result.ts';
import type {
  PrincipalEntity,
  PermissionScope,
} from '@/modules/features/role/domain/structs/permission.struct.ts';
import type { GrpcPermissionRemoteDataSource } from '@/modules/features/role/infrastructure/data/grpc-permission-remote.data-source.ts';
import type {
  RoleCreationData,
  RoleEntity,
...
import type { AuthzVocabularyEntity } from '@/modules/features/role/domain/entities/authz-vocabulary.entity.ts';
import { GrpcRoleMapper } from '@/modules/features/role/infrastructure/repository/mappers/grpc-role.mapper.ts';
import { GrpcGrantMapper } from '@/modules/features/role/infrastructure/repository/mappers/grpc-grant.mapper.ts';
import { GrpcGrantableRoleMapper } from '@/modules/features/role/infrastructure/repository/mappers/grpc-grantable-role.mapper.ts';
import { GrpcEffectivePermissionsMapper } from '@/modules/features/role/infrastructure/repository/mappers/grpc-effective-permissions.mapper.ts';
import { GrpcAuthzVocabularyMapper } from '@/modules/features/role/infrastructure/repository/mappers/grpc-authz-vocabulary.mapper.ts';
