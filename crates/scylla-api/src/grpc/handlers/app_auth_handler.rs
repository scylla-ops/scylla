...
use scylla_core::application::{AppRepository, AppTokenRepository, AppTokenUseCases, HashService};
...
#[derive(Constructor)]
pub struct AppAuthHandler<A, T, H>
where
    A: AppRepository,
    T: AppTokenRepository,
    H: HashService,
{
    use_cases: Arc<AppTokenUseCases<A, T, H>>,
}
...
> AppAuthService for AppAuthHandler<A, T, H>
{
